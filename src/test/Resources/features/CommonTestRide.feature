...
Feature: Submit Test Ride Form from generic page
  ...
  Scenario Outline: Submit test ride form for different vehicles
    Given the user is on the test ride page on "TestRide_UAT"
    ...
    Examples:Positive Cases
      ...
      | TVS Jupiter           | DISC SXC                       | Test User | 7975408454   | 560060  |
      | TVS Jupiter           | DRUM                           | DRUM       | 7975408454   | 560060  |
      | TVS Jupiter           | DRUM ALLOY                     | DRUM ALLOY | 7975408454   | 560060  |
      | TVS Jupiter           | DRUM SXC                       | DRUM SXC   | 7975408454   | 560060  |
