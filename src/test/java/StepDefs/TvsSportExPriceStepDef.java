...
import com.tvs.pages.TvsSportExPricePage;
...
public class TvsSportExPriceStepDef
{
    ...
    Response response;
    TvsSportExPricePage sportExPricePage;
    ...
    public TvsSportExPriceStepDef() {
        ...
        sportExPricePage= new TvsSportExPricePage(driver);
    ...
    public void iterateThroughEachStateToSelectAndGetExShowRoomPrices() throws IOException {
